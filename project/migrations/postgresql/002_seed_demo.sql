...
('50000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000001', 1, 'TH-1', 'Create portable persistence layer', 'Define a database interface and independent PostgreSQL and SQLite adapters.', '10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000005', '30000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000002', 5, NULL, CURRENT_TIMESTAMP - INTERVAL '6 days', CURRENT_TIMESTAMP - INTERVAL '1 day'),
('50000000-0000-4000-8000-000000000002', '40000000-0000-4000-8000-000000000001', 2, 'TH-2', 'Design project dashboard', 'Create summary cards, recent issues, and project navigation.', '10000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000003', '30000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000003', 3, NULL, CURRENT_TIMESTAMP - INTERVAL '5 days', CURRENT_TIMESTAMP - INTERVAL '2 hours'),
('50000000-0000-4000-8000-000000000003', '40000000-0000-4000-8000-000000000001', 3, 'TH-3', 'Add Kanban board', 'Render status columns and allow status changes.', '10000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000002', 8, NULL, CURRENT_TIMESTAMP - INTERVAL '4 days', CURRENT_TIMESTAMP - INTERVAL '5 hours'),
('50000000-0000-4000-8000-000000000004', '40000000-0000-4000-8000-000000000001', 4, 'TH-4', 'Implement issue creation dialog', 'Validate required fields and return the created issue.', '10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000002', '30000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000003', NULL, 3, NULL, CURRENT_TIMESTAMP - INTERVAL '3 days', CURRENT_TIMESTAMP - INTERVAL '1 day'),
('50000000-0000-4000-8000-000000000005', '40000000-0000-4000-8000-000000000001', 5, 'TH-5', 'Fix mobile board overflow', 'Kanban columns should remain usable on narrow screens.', '10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000002', NULL, 2, NULL, CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP - INTERVAL '2 days'),
('50000000-0000-4000-8000-000000000006', '40000000-0000-4000-8000-000000000001', 6, 'TH-6', 'Document MVP boundaries', 'State explicitly which Jira areas are not part of Ticket Hub.', '10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000001', 1, NULL, CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP - INTERVAL '1 day'),
('50000000-0000-4000-8000-000000000007', '40000000-0000-4000-8000-000000000002', 1, 'WEB-1', 'Publish landing page', 'Prepare a simple product landing page.', '10000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000003', '30000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000002', 5, NULL, CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP - INTERVAL '3 hours'),
('50000000-0000-4000-8000-000000000008', '40000000-0000-4000-8000-000000000002', 2, 'WEB-2', 'Add API documentation', 'Document health, projects, issues, status, and comments endpoints.', '10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000002', '30000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000003', 2, NULL, CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP - INTERVAL '7 hours')
ON CONFLICT DO NOTHING;
